...
IOTCORE_TOPIC = 'IotCore/MyClientDevice-raspberrypi1/hello/world'
CLIENT_TOPIC_PUB = 'clients/MyClientDevice-raspberrypi1/hello/world'
...
def main():
    ...
    message = {}
    message['message'] = 'From raspberry1.'
    # message['sequence'] = 'a'
